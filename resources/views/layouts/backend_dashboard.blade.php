...
<li class="notifications dropdown">
	...
	<link rel="stylesheet" href="{{asset('assets/backend/js/jvectormap/jquery-jvectormap-1.2.2.css')}}">
	<link rel="stylesheet" href="{{asset('assets/backend/js/rickshaw/rickshaw.min.css')}}">

	<!-- Bottom scripts (common) -->
	<script src="{{asset('assets/backend/js/gsap/TweenMax.min.js')}}"></script>
	...
	<script src="{{asset('assets/backend/js/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>


	<!-- Imported scripts on this page -->
	<script src="{{asset('assets/backend/js/jvectormap/jquery-jvectormap-europe-merc-en.js')}}"></script>
	<script src="{{asset('assets/backend/js/jquery.sparkline.min.js')}}"></script>
	<script src="{{asset('assets/backend/js/rickshaw/vendor/d3.v3.js')}}"></script>
	<script src="{{asset('assets/backend/js/rickshaw/rickshaw.min.js')}}"></script>
