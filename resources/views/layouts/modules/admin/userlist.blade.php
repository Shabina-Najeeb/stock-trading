...
<div class="col-md-12">
            ...
            <form style="display:none" role="form" id="user_form" class="form-horizontal form-groups-bordered">
...
<script src="{{asset('assets/backend/dist/js/pages/userlist.js')}}"></script>
